 ...
 * @generated from protobuf service simple.SimpleCompute
 */
export class SimpleComputeClient
  extends grpc.Client
  implements ISimpleComputeClient
{
  ...
  add(
    ...
    metadata:
      | grpc.Metadata
      | grpc.CallOptions
      | ((err: grpc.ServiceError | null, value?: OperationResponse) => void),
    options?:
      | grpc.CallOptions
      | ((err: grpc.ServiceError | null, value?: OperationResponse) => void),
    callback?: (
    ...
    return this.makeUnaryRequest<OperationRequest, OperationResponse>(
      `/${SimpleCompute.typeName}/${method.name}`,
      (value: OperationRequest): Buffer =>
        Buffer.from(method.I.toBinary(value, this._binaryOptions)),
      (value: Buffer): OperationResponse =>
